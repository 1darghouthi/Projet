...
function creativeily_spbThemesNotification(){
	...
	$notifications->Add("creativeily_notification", "Unlock All Features with Creativeily Premium", "
		
		Take advantage of the up to <span style='font-weight:bold;'>45% discount</span> and unlock all features with Creativeily Premium. 
		The discount is only available for a limited time.

		<div>
		<a style='margin-bottom:15px;' class='button button-large button-secondary' target='_blank' href='https://superbthemes.com/creativeily/'>Read more</a> <a style='margin-bottom:15px;' class='button button-large button-primary' target='_blank' href='https://superbthemes.com/creativeily/'>Buy now</a>
		</div>
